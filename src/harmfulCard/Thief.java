...
public class Thief extends HarmfulCard {
    ...
    public void harass (Player p, Player pp) {
        ...
        System.out.println("Thief harassing!");
    }

    @Override
    public String toString() {
        return "Thief{transfer " + bricks_steal + " bricks, " + weapons_steal + " weapons, " + mana_steal + " mana}";
    }
